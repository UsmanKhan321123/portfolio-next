...
function About(){
    return(
        ...
        <div className="w-[50vw] p-[50px] ">
                    ...
                    <p className="my-[30px]">I specialize in empowering businesses through innovative digital solutions. With a focus on digital marketing, website development, eCommerce, and mobile application development, I tailor my services to meet the unique needs of each client. I combine creativity and technical expertise to drive growth and enhance online presence. I believe in forging lasting partnerships, ensuring that my clients not only succeed but thrive in the digital landscape. From startups to established enterprises, I am dedicated to delivering high-quality, results-driven services that help you achieve your business goals. Let's transform your vision into reality!</p>
                    <Button />
                </div>
                <div className="w-[50vw] p-[50px]  ">
